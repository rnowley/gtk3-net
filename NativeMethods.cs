...
namespace gtk3_net
{
    public static class NativeMethods
    {
        ...
        public static extern uint g_signal_connect_data(IntPtr instance, string detiledSignal, IntPtr handler, IntPtr data, GClosureNotify destroyData, GConnectFlags connectFlags);
        ...
        [DllImport(GObjLib, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint g_signal_connect_swapped(IntPtr instance, string detailedSignal, IntPtr handler, IntPtr data);
